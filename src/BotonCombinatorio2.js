...
class BotonCombinatorio2 extends THREE.Object3D {
  constructor() {
    super();
    ...
    this.botonCombinatorio2 = new THREE.Object3D();
    this.botonCombinatorio2.add(this.base);
    this.botonCombinatorio2.add(this.pulsador);
  ...
  crearPulsador(){
    ...
    var pulsadorMat = new THREE.MeshPhongMaterial({color: 0x008000});
